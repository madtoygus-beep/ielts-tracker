        ...
        {scores.length === 0 ? (
          <div className="bg-white border border-gray-100 rounded-2xl p-12 text-center mb-8">
            ...
            <p className="text-gray-400 text-sm">
              Your teacher will log your IELTS scores here. Check back after
              your next test!
            </p>
          </div>
        ) : (
                ...
                {scores.map((score, i) => (
                  ...
                  >
                    <div className="flex items-center justify-between mb-2">
                      ...
                      <p
                        className={`text-xl font-bold ${getBandColor(
                          score.overall
                        )}`}
                      >
                        {score.overall}
                    ...
                    <div className="grid grid-cols-4 gap-2">
                      {['listening', 'reading', 'writing', 'speaking'].map(
                        skill => (
                          <div
                            key={skill}
                            className={`rounded-lg p-2 text-center ${getBandBg(
                              score[skill]
                            )}`}
                          >
                            ...
                            <p
                              className={`text-sm font-semibold ${getBandColor(
                                score[skill]
                              )}`}
                            >
                              {score[skill]}
